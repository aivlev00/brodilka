...
public class Brodilka extends JFrame {
    ...
    private void canvasMouseMoved(MouseEvent evt) {//GEN-FIRST:event_canvasMouseMoved
        ...
        renderer.rot=renderer.rot+(lastx-mx)*renderer.speed/60;
        renderer.RecountPxPyPz();
        ...
        renderer.rotz=renderer.rotz+(lasty-my)*renderer.speed/20;
        renderer.RecountPxPyPz();
